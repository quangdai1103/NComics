...
export const meta = (data?: { title?: string; description?: string }) => {
  ...
  return {
    title: title || 'NextZ Comics | Free comics and manga reader online',
    ogTitle: title || 'NextZ Comics | Free comics and manga reader online',
    description:
      description ||
      'Read hottest Japanese manga & Chinese comic & anime & Webtoon released on NextZ Comics. Thousands of popular web manga and comics for free! Romance, thriller, fantasy, comedy and more genres for you to explore.',
    ogDescription:
      description ||
      'Read hottest Japanese manga & Chinese comic & anime & Webtoon released on NextZ Comics. Thousands of popular web manga and comics for free! Romance, thriller, fantasy, comedy and more genres for you to explore.',
